...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        subprocess.check_call(
            ["cmake", ext.sourcedir] + cmake_args, cwd=self.build_temp, env=env, stdout=open('output_ext.log', 'w'),stderr=open('error_ext.log', 'w')
        )
        subprocess.check_call(
            ["cmake","--build", "."] + build_args, cwd=self.build_temp, stdout=open('output_build.log', 'w'),stderr=open('error_build.log', 'w')
        )
...
setup(
    ...
    ext_modules=[
        ...
        CMakeExtension("qsimcirq/qsim_rvv"),
    ],
