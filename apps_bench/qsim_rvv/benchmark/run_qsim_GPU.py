...
gpu_options = qsimcirq.QSimOptions(use_gpu=True, gpu_mode = 0, max_fused_gate_size=args.fused_gate)
...
print(f"\nBenchmark: {args.benchmark}; threads: {args.threads}; fused_gate: {args.fused_gate};")
