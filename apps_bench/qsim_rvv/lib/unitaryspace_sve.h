...
#ifndef UNITARYSPACE_SVE_H_
#define UNITARYSPACE_SVE_H_
...
struct UnitarySpaceSVE
    : public UnitarySpace<UnitarySpaceSVE<For, FP>, VectorSpace, For, FP> {
 private:
  using Base = UnitarySpace<UnitarySpaceSVE<For, FP>,
 ...
 public:
  ...
  explicit UnitarySpaceSVE(ForArgs&&... args) : Base(args...) {}
